        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignImageUrl = table.Column<string>(nullable: true),
                    ...
                    AadharNo = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelationToNominee = table.Column<string>(nullable: true),
                    LoanAccount_InterestRate = table.Column<double>(nullable: true),
                    DurationInMonths = table.Column<int>(nullable: true),
                    EMI = table.Column<double>(nullable: true),
                    OutstandingBalance = table.Column<double>(nullable: true),
                    SIEnabled = table.Column<bool>(nullable: true),
                    SIDate = table.Column<DateTime>(nullable: true),
                    SavingAccountNo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferLimit = table.Column<double>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    CustomerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
